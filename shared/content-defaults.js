...
export const defaults = {
  ...
  home: {
    ...
    partners: {
      ...
      headline: "20팀의 크리에이터가\n더퍼스트제너레이션과 함께합니다",
      accent: "더퍼스트제너레이션",
      items: [
        { name: "광주푸드스탑", src: "/creators/gwangju-food-stop.svg" },
        { name: "1분맛집", src: "/creators/1min-food.svg" },
        { name: "하늘고마", src: "/creators/skygoma.svg" },
        { name: "김수민 작가", src: "/creators/youloveday.svg" },
        { name: "빅브로 로스터스", src: "/creators/bigbro-roasters.svg" },
        { name: "6338hj", src: "/creators/6338hj.svg" },
        { name: "콧털이과장", src: "/creators/kotteol.svg" },
        { name: "성공인사이드", src: "/creators/success-inside.svg" },
        { name: "장첸", src: "/creators/jangchen.svg" },
        { name: "H모터스", src: "/creators/h-motors.svg" },
        { name: "오로지스튜디오", src: "/creators/orozi-studio.svg" },
      ],
    },
    testimonials: {
