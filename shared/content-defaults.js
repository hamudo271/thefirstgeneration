...
export const defaults = {
  ...
  home: {
    ...
    partners: {
      ...
      accent: "더퍼스트제너레이션",
      items: [
        { name: "1분맛집", channel: "유튜브", followers: "9.64만명", desc: "맛집 소개", href: "" },
        { name: "광주푸드스탑", channel: "인스타", followers: "12.6만명", desc: "맛집 소개", href: "https://www.instagram.com/gwangju_food_stop" },
        { name: "광주일번 인싸영감", channel: "유튜브", followers: "5.78천명", desc: "맛집 소개", href: "" },
        { name: "광주스토리", channel: "인스타", followers: "3.3만명", desc: "맛집 소개", href: "https://www.instagram.com/gwangju.story" },
        { name: "제대로농수산", channel: "유튜브", followers: "3.25천명", desc: "농수산물 유통", href: "" },
        { name: "테인핏", channel: "인스타", followers: "1.4만명", desc: "헬스 인플루언서", href: "https://www.instagram.com/teain_fit" },
        { name: "예찬하다 | YECHAN", channel: "유튜브", followers: "2.24천명", desc: "커플/호텔 브이로그", href: "" },
        ...
        { name: "성공인사이드", channel: "유튜브", followers: "1.41만명", desc: "사업가 소개", href: "" },
        { name: "하늘고마", channel: "유튜브", followers: "4.76만명", desc: "부업/어플/가상화폐", href: "" },
        { name: "김수민 작가", channel: "팔로워", followers: "3.5만명", desc: "작가/에세이", href: "" },
        { name: "장첸-길출신 아기고양이", channel: "유튜브", followers: "1.82만명", desc: "반려동물/고양이", href: "" },
